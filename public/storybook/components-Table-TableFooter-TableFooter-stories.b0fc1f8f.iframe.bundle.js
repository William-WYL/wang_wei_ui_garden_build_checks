...
(self.webpackChunkui_garden = self.webpackChunkui_garden || []).push([
  [856],
  {
    ...
    './src/components/Table/TableFooter/TableFooter.stories.tsx': (
      ...
      const StyledTfoot = styled_components_browser_esm.Ay.tfoot(
        ...
        TableFooter = (_ref3) => {
          let { children, disabled, className } = _ref3;
          return (0, jsx_runtime.jsx)(StyledTfoot, {
            className,
            children: (0, jsx_runtime.jsx)('tr', {
              children: react.Children.map(children, (child) => {
                if (react.isValidElement(child)) {
                  const element = child;
                  return (0, jsx_runtime.jsx)(StyledTd, { disabled, children: element.props.children });
                }
                return (0, jsx_runtime.jsx)(StyledTd, { disabled, children: child });
              }),
            }),
          });
        },
        TableFooter_TableFooter = TableFooter;
      ...
      const TableFooter_stories = {
          title: 'Components/Table/TableFooter',
          component: TableFooter_TableFooter,
          tags: ['autodocs'],
        ...
        Default = {
          args: {
            children: (0, jsx_runtime.jsxs)(jsx_runtime.Fragment, {
              children: [
                (0, jsx_runtime.jsx)(TableCell.A, { children: 'Footer 1' }),
                (0, jsx_runtime.jsx)(TableCell.A, { children: 'Footer 2' }),
              ],
            }),
            disabled: !1,
          },
