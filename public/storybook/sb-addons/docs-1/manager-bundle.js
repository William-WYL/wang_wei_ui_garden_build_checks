...
`,
    ...
    function Re(e, t, r) {
      ...
      if (typeof e == 'object' && t === void 0 && r === void 0) return O(e.hue, e.saturation, e.lightness);
      throw new b(1);
    }
    function Ie(e, t, r, a) {
    ...
    function q(e, t, r) {
      if (typeof e == 'number' && typeof t == 'number' && typeof r == 'number') return $('#' + v(e) + v(t) + v(r));
      if (typeof e == 'object' && t === void 0 && r === void 0) return $('#' + v(e.red) + v(e.green) + v(e.blue));
      throw new b(6);
    }
    function F(e, t, r, a) {
    ...
    var Ze = c(Ue),
      ...
      rt = ({ isLoading: e, error: t, language: r, code: a, dark: n, format: o = !0, ...s }) => {
        ...
        return l.createElement(ee, { theme: te({ ...u, fontCode: i.fonts.mono, fontBase: i.fonts.base }) }, p);
      };
    H.register(W, (e) => {
      H.add(le, {
        title: 'Code',
