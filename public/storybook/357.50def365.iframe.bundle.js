...
(self.webpackChunkui_garden = self.webpackChunkui_garden || []).push([
  [357],
  {
    './node_modules/@storybook/addon-docs/dist/Color-AVL7NMMY.mjs': (
      ...
      var _chunk_SPFYY5GD_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
          './node_modules/@storybook/addon-docs/dist/chunk-SPFYY5GD.mjs',
        ),
        _chunk_QUZPS4B6_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
        ...
        storybook_theming__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
          './node_modules/storybook/dist/theming/index.js',
        ),
        require_color_name = (0, _chunk_QUZPS4B6_mjs__WEBPACK_IMPORTED_MODULE_0__.P$)({
        ...
        require_conversions = (0, _chunk_QUZPS4B6_mjs__WEBPACK_IMPORTED_MODULE_0__.P$)({
            ...
            ((convert2.rgb.hsl = function (rgb) {
              ...
              (convert2.hsl.hsv = function (hsl) {
                ...
                return (
                  ...
                  [h2, 100 * (0 === l2 ? (2 * smin) / (lmin + smin) : (2 * s2) / (l2 + s2)), 100 * ((l2 + s2) / 2)]
                );
              }),
              ...
              (convert2.rgb.ansi256 = function (args) {
                ...
                return r2 === g2 && g2 === b2
                  ...
                  : 16 + 36 * Math.round((r2 / 255) * 5) + 6 * Math.round((g2 / 255) * 5) + Math.round((b2 / 255) * 5);
              }),
              ...
              (convert2.hcg.hsl = function (hcg) {
                let c2 = hcg[1] / 100,
                  ...
                  s2 = 0;
                return (
                  l2 > 0 && l2 < 0.5 ? (s2 = c2 / (2 * l2)) : l2 >= 0.5 && l2 < 1 && (s2 = c2 / (2 * (1 - l2))),
                  [hcg[0], 100 * s2, 100 * l2]
                );
              }),
        ...
        require_route = (0, _chunk_QUZPS4B6_mjs__WEBPACK_IMPORTED_MODULE_0__.P$)({
        ...
        require_color_convert = (0, _chunk_QUZPS4B6_mjs__WEBPACK_IMPORTED_MODULE_0__.P$)({
                ...
                ((convert2[fromModel][toModel] = (function wrapRounded(fn) {
                  let wrappedFn = function (...args) {
                    ...
                    if ('object' == typeof result)
                      for (let len = result.length, i2 = 0; i2 < len; i2++) result[i2] = Math.round(result[i2]);
                    return result;
                  };
        ...
        import_color_convert = (0, _chunk_QUZPS4B6_mjs__WEBPACK_IMPORTED_MODULE_0__.f1)(require_color_convert());
      function u() {
        return (u =
          Object.assign ||
          function (e2) {
      ...
      var ColorSpace2,
        ...
        Wrapper = storybook_theming__WEBPACK_IMPORTED_MODULE_2__.I4.div({
          position: 'relative',
          maxWidth: 250,
          '&[aria-readonly="true"]': { opacity: 0.5 },
        }),
        PickerTooltip = (0, storybook_theming__WEBPACK_IMPORTED_MODULE_2__.I4)(
          storybook_internal_components__WEBPACK_IMPORTED_MODULE_3__.kR,
        )({ position: 'absolute', zIndex: 1, top: 4, left: 4, '[aria-readonly=true] &': { cursor: 'not-allowed' } }),
        TooltipContent = storybook_theming__WEBPACK_IMPORTED_MODULE_2__.I4.div({
          width: 200,
          margin: 5,
        ...
        Note = (0, storybook_theming__WEBPACK_IMPORTED_MODULE_2__.I4)(
          storybook_internal_components__WEBPACK_IMPORTED_MODULE_3__._,
        )(({ theme }) => ({ fontFamily: theme.typography.fonts.base })),
        Swatches = storybook_theming__WEBPACK_IMPORTED_MODULE_2__.I4.div({
          display: 'grid',
        ...
        SwatchColor = storybook_theming__WEBPACK_IMPORTED_MODULE_2__.I4.div(({ theme, active }) => ({
          width: 16,
          height: 16,
          boxShadow: active
        ...
        Input = (0, storybook_theming__WEBPACK_IMPORTED_MODULE_2__.I4)(
        ...
        ToggleIcon = (0, storybook_theming__WEBPACK_IMPORTED_MODULE_2__.I4)(
              ...
              : HSL_REGEXP.test(value)
                ...
                : ((value) => {
                    let plain = value.replace('#', ''),
                      rgb =
                        import_color_convert.default.keyword.rgb(plain) || import_color_convert.default.hex.rgb(plain),
        ...
        ColorControl = ({
          ...
          let debouncedOnChange = (0, react__WEBPACK_IMPORTED_MODULE_1__.useCallback)(
              (0, _chunk_SPFYY5GD_mjs__WEBPACK_IMPORTED_MODULE_5__.sg)(onChange, 200),
              [onChange],
            ),
            ...
            { presets, addPreset } = ((presetColors, currentColor, colorSpace) => {
              let [selectedColors, setSelectedColors] = (0, react__WEBPACK_IMPORTED_MODULE_1__.useState)(
                ...
                addPreset = (0, react__WEBPACK_IMPORTED_MODULE_1__.useCallback)(
                  (color) => {
                    color?.valid &&
                      (presets.some(
                        (preset) =>
                          preset && preset[colorSpace] && id(preset[colorSpace] || '') === id(color[colorSpace] || ''),
                      ) ||
          ...
          return react__WEBPACK_IMPORTED_MODULE_1__.createElement(
            ...
            react__WEBPACK_IMPORTED_MODULE_1__.createElement(
              PickerTooltip,
              {
                ...
                tooltip: react__WEBPACK_IMPORTED_MODULE_1__.createElement(
                  TooltipContent,
                  null,
                  react__WEBPACK_IMPORTED_MODULE_1__.createElement(Picker, {
            ...
            react__WEBPACK_IMPORTED_MODULE_1__.createElement(Input, {
              id: (0, _chunk_SPFYY5GD_mjs__WEBPACK_IMPORTED_MODULE_5__.ZA)(name),
              value,
